...
public:
    ...
    void setupUi(QDialog *TripWindow)
    {
        ...
        printCustomButton->setGeometry(QRect(260, 120, 93, 28));
        ...
        addSouvButton->setGeometry(QRect(240, 310, 93, 28));
